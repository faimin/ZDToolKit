...
+ (instancetype)scrollViewWithFrame:(CGRect)frame delegate:(nullable id<ZDBannerScrollViewDelegate>)delegate placeholderImage:(nullable NSString *)placeholderImageName;
